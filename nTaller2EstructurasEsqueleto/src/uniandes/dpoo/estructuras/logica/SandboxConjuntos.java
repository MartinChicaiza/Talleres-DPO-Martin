...
public class SandboxConjuntos
{
    ...
    {
        List<String> listaInvertida = new ArrayList<String>(arbolCadenas.descendingSet());
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        for (String cadenaEnConjunto : arbolCadenas)
        {
            if (cadenaEnConjunto.equalsIgnoreCase(cadena))
            {
                cadenaEncontrada = cadenaEnConjunto;
                break;
            }
        }
    ...
    {
        TreeSet<String> conjuntoMayusculas = new TreeSet<String>();
        for (String cadenaEnConjunto : arbolCadenas)
        {
            conjuntoMayusculas.add(cadenaEnConjunto.toUpperCase());
        }
